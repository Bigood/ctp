...
export const getCurrentUser = async (
  ...
  //Récupération de l'utilisateur via GQL
  //Typeof typeguard https://stackoverflow.com/a/63690726/1437016 pour TS unkwown en string
  const id: string = typeof decoded.sub === "string" ? decoded.sub : undefined;

  const user = await db.user.findUnique({ where: {cuid: id}})
