...
CREATE TABLE "auth"."identities" (
    ...
    "created_at" TIMESTAMPTZ(6),
    "updated_at" TIMESTAMPTZ(6),
    "email" TEXT GENERATED ALWAYS AS (lower((identity_data->>'email'::text))) STORED, -- https://github.com/prisma/prisma/issues/17734#issuecomment-1452011006
...
CREATE TABLE "auth"."users" (
    ...
    "confirmed_at" TIMESTAMPTZ(6) GENERATED ALWAYS AS (LEAST(email_confirmed_at, phone_confirmed_at)) STORED, -- https://github.com/prisma/prisma/issues/17734#issuecomment-1452011006
